    ...
    public class Todo : CalComponent
    {
        ...
        protected override bool ProcessProperty(ICalReader reader, ContentLine line)
        {
            switch (line.Name.ToUpper())
            {
                ...
                case Constants.DESCRIPTION: SetProperty(reader.MakeProperty<TextProperty>(line), Constants.DESCRIPTION); return true;
        ...
        {
            get { return FindProperty<TextProperty>(Constants.DESCRIPTION); }
